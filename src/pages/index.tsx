  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12 space-y-6">
        {error && (
          <div className={cn(cardClasses, "bg-red-500/10 border-red-500/20")}>
            {error}
          </div>
        )}
          ...
          <div className={cardClasses}>
            <div className="space-y-1">
              ...
              <div className="text-sm text-gray-300 space-y-0.5">
                ...
                <p>{balance?.toString() === '[object Object]'
                  ? '0.00'
                  : parseFloat(balance?.toString() || '0').toFixed(4)} ETH
                </p>
                <p>{chainId === NETWORK_CONFIG['Ethereum Sepolia'].chainId 
                  ? 'Ethereum Sepolia' 
        ...
        {address && analysisResults && (
          <div className={cardClasses}>
            <h2 className="text-lg font-medium mb-4 text-white">Portfolio Inspection</h2>
        ...
        {showMarketAnalysis && analysis && (
          <div className={cardClasses}>
            <h2 className="text-lg font-medium mb-4 text-white">Market Analysis</h2>
          ...
          <div className={cardClasses}>
            ...
            <div className="mt-8 flex justify-end">
              <Button
                ...
                className={recommendButtonClasses}
              >
        ...
        {showRecommendations && analysis && (
          <div className={cardClasses}>
            <h2 className="text-lg font-medium mb-4 text-white">Assetly Recommends</h2>
